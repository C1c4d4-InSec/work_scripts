# -*- coding: utf-8 -*-
"""
Created on Fri Dec  3 11:02:41 2021
...
try:
    ...
    excelSplitButton = tk.Button(text='Excel Split', width=15, height=2, command=excelfile)
    
    excelSplitButton.pack()
    
    excelSplitButton.mainloop()
